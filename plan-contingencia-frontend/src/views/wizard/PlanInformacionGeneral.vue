<template>
  <section class="plan-information">
    <h2 class="plan-information__title">Información General</h2>
    ...
    <div class="plan-information__grid">
      <div class="plan-information__field plan-information__field--half">
        ...
        <BaseSelect
          ...
          v-model="form.programaFormacionId"
          label="Programa de formación"
          placeholder="Seleccione un programa de formación"
      ...
      <div class="plan-information__field plan-information__field--half">
        <label class="plan-information__label" for="actividad"> Actividad <span>*</span> </label>
      ...
      <div class="plan-information__field plan-information__field--third">
        ...
        <BaseTimePicker
          id="hora-regreso"
          v-model="form.horaRegreso"
          label="Hora de regreso prevista"
          placeholder="00:00 p. m."
          required
          external-label
          icon-position="append"
          size="wizard"
          :rules="[requiredRule, returnTimeRule]"
          width="100%"
        />
      </div>
      ...
      <div class="plan-information__field plan-information__field--half">
        ...
        <BaseInput
          id="lugar-salida"
          v-model="form.lugarSalida"
          label="Lugar de salida"
          placeholder="Escriba el lugar de salida"
          icon="location_on"
          icon-position="append"
          required
          external-label
      ...
      <div class="plan-information__field plan-information__field--half">
        ...
        <BaseSelect
          id="clasificacion-informacion"
          v-model="form.clasificacionInformacion"
          label="Clasificación de la información"
          placeholder="Seleccione la clasificación"
          :options="CLASIFICACION_INFORMACION_OPTIONS"
          option-label="label"
          option-value="value"
          required
          external-label
    ...
    <div class="plan-information__notice">
      ...
      <div>
        ...
        <p>
          Los campos marcados con <span>*</span> son obligatorios para continuar con la creación del
          plan.
        </p>
      </div>
    </div>
...
function dateRule(value) {
  ...
  const normalizedDate =
    dateParts.length === 3 ? `${dateParts[2]}-${dateParts[1]}-${dateParts[0]}` : value
...
function returnTimeRule(value) {
  ...
  return regreso > salida || 'La hora de regreso debe ser posterior a la hora de salida'
}
