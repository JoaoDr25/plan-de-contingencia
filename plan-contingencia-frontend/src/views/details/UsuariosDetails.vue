        ...
        <div class="user-detail detail-grid">
            ...
            <section class="detail-card detail-card--work">
                ...
                <div class="detail-card__fields detail-card__fields--work">
                    ...
                    <BaseDetailItem label="Centro de Formación" :value="userData?.centro || 'No registrado'" />

                    <BaseDetailItem label="Red de Conocimiento" :value="userData?.redConocimiento || 'No registrada'" />

                     <BaseDetailItem label="Área Temática" :value="userData?.areaTematica || 'No registrada'" />

                    <BaseDetailItem label="Tipo de Vinculación" :value="userData?.tipoVinculacion || 'No registrado'" />
            ...
            <section class="detail-card detail-card--access">
                ...
                <div class="detail-card__fields detail-card__fields--access">
                    ...
                    <BaseDetailItem label="Correo Institucional" :value="userData?.correo || 'No registrado'" />

                    <BaseDetailItem label="Correo Personal" :value="userData?.correoPersonal || 'No registrado'" />
