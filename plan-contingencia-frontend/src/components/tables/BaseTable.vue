<template>
  <div class="base-table">
    ...
    >
      <template #no-data>
        <div class="base-table__empty">No existen registros para mostrar</div>
      </template>
    ...
    <BasePagination
      ...
      @change-rows-per-page="emit('change-rows-per-page', $event)"
    />
  </div>
</template>
...
const { rows, columns, rowKey, loading, currentPage, totalPages, start, end, total } = defineProps({
  rows: {
    type: Array,
    default: () => [],
  },
